...
class TicketType extends TdxClient
{
    ...
    /**
     * @link https://solutions.teamdynamix.com/SBTDWebApi/Home/section/TicketTypes#GETapi/{appId}/tickets/types
     */
    public function all(): Response
    {
        return $this->get(sprintf('/api/%s/tickets/types', $this->tdxApplication->id));
    }
}
